...
\[ [X_{(2)},Y_{(2)}]_{(0)} = \frac{1}{2} \sum_{J} (2J+1) \sum_{abcd} (n_a n_b \bar{n}_c \bar{n}_d) X_{abcd}^{J} Y_{cdab}^{J} \] may be rewritten as \[ [X_{(2)},Y_{(2)}]_{(0)} = \frac{1}{2} \sum_{J} (2J+1) Tr(\mathcal{P}_{hh} X_{(2)}^{J} \mathcal{P}_{pp} Y_{(2)}^{J} \mathcal{P}_{hh}) \] where $ \mathcal{P}_{hh} $ is a projector onto hole-\/hole two body states. \hypertarget{classOperator_a423dc256b5780dbee20ac81c9a655335}{\index{Operator@{Operator}!comm221ss@{comm221ss}}
