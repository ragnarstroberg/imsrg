...
\hyperlink{classOperator}{Operator} \hyperlink{classOperator_a55b95477ad8674877eb4d15491cfe9a0}{Commutator\-Scalar\-Scalar} (\hyperlink{classOperator}{Operator} \&opright)
\item 
\hyperlink{classOperator}{Operator} \hyperlink{classOperator_a7db0372f91cffc85b293f7750c72944a}{Commutator\-Scalar\-Tensor} (\hyperlink{classOperator}{Operator} \&opright)
\item 
...
\begin{DoxyCompactItemize}
\item 
\hyperlink{classOperator}{Operator} \hyperlink{classOperator_aeef048661e7456fb28828096ba12cb53}{Commutator} (\hyperlink{classOperator}{Operator} \&X, \hyperlink{classOperator}{Operator} \&Y)
\end{DoxyCompactItemize}
...
Returns $ [X_{(1)},Y_{(2)}]_{(2)} - [Y_{(1)},X_{(2)}]_{(2)} $, where \[ [X_{(1)},Y_{(2)}]^{J}_{ijkl} = \sum_{a} ( X_{ia}Y^{J}_{ajkl} + X_{ja}Y^{J}_{iakl} - X_{ak} Y^{J}_{ijal} - X_{al} Y^{J}_{ijka} ) \] here, all T\-B\-M\-E are unnormalized, i.\-e. they should have a tilde. \hypertarget{classOperator_ac924a2af30154c83d6b821707689caa5}{\index{Operator@{Operator}!comm220ss@{comm220ss}}
...
\[ [X_{(2)},Y_{(2)}]_{(0)} = \frac{1}{2} \sum_{J} (2J+1) \sum_{abcd} (n_a n_b \bar{n}_c \bar{n}_d) \tilde{X}_{abcd}^{J} \tilde{Y}_{cdab}^{J} \] may be rewritten as \[ [X_{(2)},Y_{(2)}]_{(0)} = 2 \sum_{J} (2J+1) Tr(X_{hh'pp'}^{J} Y_{pp'hh'}^{J}) \] where we obtain a factor of four from converting two unrestricted sums to restricted sums, i.\-e. $\sum_{ab} \rightarrow \sum_{a\leq b} $, and using the normalized T\-B\-M\-E. \hypertarget{classOperator_a423dc256b5780dbee20ac81c9a655335}{\index{Operator@{Operator}!comm221ss@{comm221ss}}
...
Calculates the part of $ [X_{(2)},Y_{(2)}]_{ijkl} $ which involves ph intermediate states, here indicated by $ Z^{J}_{ijkl} $ \[ Z^{J}_{ijkl} = \sum_{ab}(n_a\bar{n}_b-\bar{n}_an_b)\sum_{J'} (2J'+1) \left[ \left\{ \begin{array}{lll} j_i & j_j & J \\ j_k & j_l & J' \\ \end{array} \right\} \left( \bar{X}^{J'}_{i\bar{l}a\bar{b}}\bar{Y}^{J'}_{a\bar{b}k\bar{j}} - \bar{Y}^{J'}_{i\bar{l}a\bar{b}}\bar{X}^{J'}_{a\bar{b}k\bar{j}} \right) -(-1)^{j_i+j_j-J} \left\{ \begin{array}{lll} j_j & j_i & J \\ j_k & j_l & J' \\ \end{array} \right\} \left( \bar{X}^{J'}_{j\bar{l}a\bar{b}}\bar{Y}^{J'}_{a\bar{b}k\bar{i}} - \bar{Y}^{J'}_{j\bar{l}a\bar{b}}\bar{X}^{J'}_{a\bar{b}k\bar{i}} \right) \right] \] This is implemented by defining an intermediate matrix \[ \bar{Z}^{J}_{i\bar{l}k\bar{j}} \equiv \sum_{ab}(n_a\bar{n}_b) \left[ \left( \bar{X}^{J'}_{i\bar{l}a\bar{b}}\bar{Y}^{J'}_{a\bar{b}k\bar{j}} - \bar{Y}^{J'}_{i\bar{l}a\bar{b}}\bar{X}^{J'}_{a\bar{b}k\bar{j}} \right) -\left( \bar{X}^{J'}_{i\bar{l}b\bar{a}}\bar{Y}^{J'}_{b\bar{a}k\bar{j}} - \bar{Y}^{J'}_{i\bar{l}b\bar{a}}\bar{X}^{J'}_{b\bar{a}k\bar{j}} \right)\right] \] The Pandya-\/transformed matrix elements are obtained with \hyperlink{classOperator_ad468922e03d15318c23886e6bfecc168}{Do\-Pandya\-Transformation()}. The matrices $ \bar{X}^{J'}_{i\bar{l}a\bar{b}}\bar{Y}^{J'}_{a\bar{b}k\bar{j}} $ and $ \bar{Y}^{J'}_{i\bar{l}a\bar{b}}\bar{X}^{J'}_{a\bar{b}k\bar{j}} $ are related by a Hermitian conjugation, which saves two matrix multiplications. The commutator is then given by \[ Z^{J}_{ijkl} = \sum_{J'} (2J'+1) \left[ \left\{ \begin{array}{lll} j_i & j_j & J \\ j_k & j_l & J' \\ \end{array} \right\} \bar{Z}^{J'}_{i\bar{l}k\bar{j}} -(-1)^{j_i+j_j-J} \left\{ \begin{array}{lll} j_j & j_i & J \\ j_k & j_l & J' \\ \end{array} \right\} \bar{Z}^{J'}_{j\bar{l}k\bar{i}} \right] \] \hypertarget{classOperator_a0f3ee31f13fff9cb88e0e107e2acdf8a}{\index{Operator@{Operator}!comm222\-\_\-phst@{comm222\-\_\-phst}}
\index{comm222\-\_\-phst@{comm222\-\_\-phst}!Operator@{Operator}}
\subsubsection[{comm222\-\_\-phst}]{\setlength{\rightskip}{0pt plus 5cm}void Operator\-::comm222\-\_\-phst (
\begin{DoxyParamCaption}
\item[{{\bf Operator} \&}]{Y, }
\item[{{\bf Operator} \&}]{Z}
\end{DoxyParamCaption}
)}}\label{classOperator_a0f3ee31f13fff9cb88e0e107e2acdf8a}
...
Calculates the part of the commutator $ [X_{(2)},Y_{(2)}]_{(2)} $ which involves particle-\/particle or hole-\/hole intermediate states. \[ [X_{(2)},Y_{(2)}]^{J}_{ijkl} = \frac{1}{2} \sum_{ab} (\bar{n}_a\bar{n}_b - n_an_b) (X^{J}_{ijab}Y^{J}_{ablk} - Y^{J}_{ijab}X^{J}_{abkl}) \] This may be written as \[ [X_{(2)},Y_{(2)}]^{J} = \mathcal{M}^{J}_{pp} - \mathcal{M}^{J}_{hh} \] With the intermediate matrices \[ \mathcal{M}^{J}_{pp} \equiv \frac{1}{2}(X^{J} \mathcal{P}_{pp} Y^{J} - Y^{J} \mathcal{P}_{pp} X^{J}) \] and likewise for $ \mathcal{M}^{J}_{hh} $. \hypertarget{classOperator_a55b95477ad8674877eb4d15491cfe9a0}{\index{Operator@{Operator}!Commutator\-Scalar\-Scalar@{Commutator\-Scalar\-Scalar}}
\index{Commutator\-Scalar\-Scalar@{Commutator\-Scalar\-Scalar}!Operator@{Operator}}
\subsubsection[{Commutator\-Scalar\-Scalar}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Operator} Operator\-::\-Commutator\-Scalar\-Scalar (
\begin{DoxyParamCaption}
\item[{{\bf Operator} \&}]{opright}
\end{DoxyParamCaption}
)}}\label{classOperator_a55b95477ad8674877eb4d15491cfe9a0}
Commutator where $ X $ and $Y$ are scalar operators. Should be called through \hyperlink{classOperator_aeef048661e7456fb28828096ba12cb53}{Commutator()} \hypertarget{classOperator_a7db0372f91cffc85b293f7750c72944a}{\index{Operator@{Operator}!Commutator\-Scalar\-Tensor@{Commutator\-Scalar\-Tensor}}
\index{Commutator\-Scalar\-Tensor@{Commutator\-Scalar\-Tensor}!Operator@{Operator}}
\subsubsection[{Commutator\-Scalar\-Tensor}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Operator} Operator\-::\-Commutator\-Scalar\-Tensor (
\begin{DoxyParamCaption}
\item[{{\bf Operator} \&}]{opright}
\end{DoxyParamCaption}
)}}\label{classOperator_a7db0372f91cffc85b293f7750c72944a}
Commutator $[X,Y]$ where $ X $ is a scalar operator and $Y$ is a tensor operator. Should be called through \hyperlink{classOperator_aeef048661e7456fb28828096ba12cb53}{Commutator()} \hypertarget{classOperator_a652d989590422a2b26e662625b07254e}{\index{Operator@{Operator}!Do\-Normal\-Ordering2@{Do\-Normal\-Ordering2}}
...
Normal ordering of a 2body operator set up for scalar or tensor operators, but the tensor part hasn't been tested \hypertarget{classOperator_a7fd029569796107c87ff17c5a7912480}{\index{Operator@{Operator}!Do\-Normal\-Ordering3@{Do\-Normal\-Ordering3}}
...
The scalar Pandya transformation is defined as \[ \bar{X}^{J}_{i\bar{j}k\bar{l}} = - \sum_{J'} (2J'+1) \left\{ \begin{array}{lll} j_i & j_j & J \\ j_k & j_l & J' \\ \end{array} \right\} X^{J}_{ilkj} \] where the overbar indicates time-\/reversed orbits. This function is designed for use with \hyperlink{classOperator_a030805d35049c5cd62eaa84fe42e59e9}{comm222\-\_\-phss()} and so it takes in two arrays of matrices, one for hp terms and one for ph terms. \hypertarget{classOperator_a079bf469ae00de721694f1674c0cae6f}{\index{Operator@{Operator}!Do\-Tensor\-Pandya\-Transformation@{Do\-Tensor\-Pandya\-Transformation}}
\index{Do\-Tensor\-Pandya\-Transformation@{Do\-Tensor\-Pandya\-Transformation}!Operator@{Operator}}
\subsubsection[{Do\-Tensor\-Pandya\-Transformation}]{\setlength{\rightskip}{0pt plus 5cm}void Operator\-::\-Do\-Tensor\-Pandya\-Transformation (
\begin{DoxyParamCaption}
\item[{map$<$ array$<$ int, 2 $>$, arma\-::mat $>$ \&}]{Two\-Body\-\_\-\-C\-C\-\_\-hp, }
\item[{map$<$ array$<$ int, 2 $>$, arma\-::mat $>$ \&}]{Two\-Body\-\_\-\-C\-C\-\_\-ph}
\end{DoxyParamCaption}
)}}\label{classOperator_a079bf469ae00de721694f1674c0cae6f}
...
Obtain the Frobenius norm of the operator, which here is defined as \[ \|X\| = \sqrt{\|X_{(1)}\|^2 +\|X_{(2)}\|^2 } \] and \[ \|X_{(1)}\|^2 = \sum\limits_{ij} X_{ij}^2 \] 

\subsection{Friends And Related Function Documentation}
\hypertarget{classOperator_aeef048661e7456fb28828096ba12cb53}{\index{Operator@{Operator}!Commutator@{Commutator}}
\index{Commutator@{Commutator}!Operator@{Operator}}
\subsubsection[{Commutator}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Operator} Commutator (
\begin{DoxyParamCaption}
\item[{{\bf Operator} \&}]{X, }
\item[{{\bf Operator} \&}]{Y}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [friend]}}}\label{classOperator_aeef048661e7456fb28828096ba12cb53}
Returns $ Z = [X,Y] $ 
