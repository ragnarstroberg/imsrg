...
\[ [X_{1)},Y_{(1)}]_{(0)} = \sum_{a} n_a (2j_a+1) \left(X_{(1)}Y_{(1)}-Y_{(1)}X_{(1)}\right)_{aa} \] \hypertarget{classOperator_aa99f1f8918be7c5669ba9a60bed3d9cd}{\index{Operator@{Operator}!comm111ss@{comm111ss}}
...
\[ [X_{(1)},Y_{(1)}]_{(1)} = X_{(1)}Y_{(1)} - Y_{(1)}X_{(1)} \] \hypertarget{classOperator_a1180fa3d9923da924aa8d17042c23ed5}{\index{Operator@{Operator}!comm121ss@{comm121ss}}
...
Returns $ [X_{(1)},Y_{(2)}] - [Y_{(1)},X_{(2)}] $, where \[ [X_{(1)},Y_{(2)}]_{ij} = \frac{1}{2j_i+1}\sum_{ab} (n_a \bar{n}_b) \sum_{J} (2J+1) (X_{ab} Y^J_{biaj} - X_{ba} Y^J_{aibj}) \] \hypertarget{classOperator_aa47907c535f84e5775b92294a90c2101}{\index{Operator@{Operator}!comm122ss@{comm122ss}}
...
Returns $ [X_{(1)},Y_{(2)}]_{(2)} - [Y_{(1)},X_{(2)}]_{(2)} $, where \[ [X_{(1)},Y_{(2)}]^{J}_{ijkl} = \sum_{a} ( X_{ia}Y^{J}_{ajkl} + X_{ja}Y^{J}_{iakl} - X_{ak} Y^{J}_{ijal} - X_{al} Y^{J}_{ijka} ) \] \hypertarget{classOperator_aca98d46760c33cd12056701031cc6b4c}{\index{Operator@{Operator}!comm220ss@{comm220ss}}
...
\[ [X_{(2)},Y_{(2)}]_{ij} = \frac{1}{2(2j_i+1)}\sum_{J}(2J+1)\sum_{abc} (\bar{n}_a\bar{n}_bn_c + n_an_b\bar{n}_c) (X^{J}_{ciab} Y^{J}_{abcj} - Y^{J}_{ciab}X^{J}_{abcj}) \] This may be rewritten as \[ [X_{(2)},Y_{(2)}]_{ij} = \frac{1}{2j_i+1} \sum_{c} \sum_{J} (2J+1) \left( n_c \mathcal{M}^{J}_{pp,icjc} + \bar{n}_c\mathcal{M}^{J}_{hh,icjc} \right) \] With the intermediate matrix \[ \mathcal{M}^{J}_{pp} \equiv \frac{1}{2} (X^{J}\mathcal{P}_{pp} Y^{J} - Y^{J}\mathcal{P}_{pp}X^{J}) \] and likewise for $ \mathcal{M}^{J}_{hh} $ \hypertarget{classOperator_a86add7287c36700de1079e1f442b1e90}{\index{Operator@{Operator}!comm222\-\_\-phst\-\_\-pandya@{comm222\-\_\-phst\-\_\-pandya}}
...
\item[{{\bf Operator} \&}]{opout}
\end{DoxyParamCaption}
) const}}\label{classOperator_a86add7287c36700de1079e1f442b1e90}
\[ [X_{(2)}Y_{(2)}]^{J}_{ijkl} = \sum_{abJ'} (n_a - n_b) (2J'+1) \left( \left\{ \begin{array}{lll} j_i & j_ j & J \\ j_k & j_ l & J' \\ \end{array} \right\} ( \bar{X}^{J'}_{i\bar{l}a\bar{b}} \bar{Y}^{J'}_{a\bar{b}k\bar{j}} -\bar{X}^{J'}_{i\bar{l}a\bar{b}} \bar{X}^{J'}_{a\bar{b}k\bar{j}}) - (-1)^{J-j_1-j_2} [ i \leftrightarrow j ] \right) \] This may be rewritten as \[ [X_{(2)}Y_{(2)}]^{J}_{ijkl} = \sum_{J'} (2J'+1) \left\{ \begin{array}{lll} j_i & j_ j & J \\ j_k & j_ l & J' \\ \end{array} \right\} ( \bar{Z}^{J'}_{i\bar{l}k\bar{j}} - (-1)^{J-j_i-j_j} \left\{ \begin{array}{lll} j_j & j_ i & J \\ j_k & j_ l & J' \\ \end{array} \right\} \bar{Z}^{J'}_{j\bar{l}k\bar{i}} ) \] with the Pandya transformed commutator defined as \[ \bar{Z}^{J'}_{i\bar{j}k\bar{l}} \equiv \sum_{ab} (n_a\bar{n}_b - \bar{n}_a n_b ) ( \bar{X}^{J'}_{i\bar{j}a\bar{b}} \bar{Y}^{J'}_{a\bar{b}k\bar{j}} - \bar{Y}^{J'}_{i\bar{j}a\bar{b}} \bar{X}^{J'}_{a\bar{b}k\bar{j}} ) \] \hypertarget{classOperator_a26be1b965a86598764be26a11490de6b}{\index{Operator@{Operator}!comm222\-\_\-pp\-\_\-hh\-\_\-221ss@{comm222\-\_\-pp\-\_\-hh\-\_\-221ss}}
...
Since \hyperlink{classOperator_a5f0ebafd8284747ca0dcb35bf2fd4fb0}{comm222\-\_\-pp\-\_\-hhss()} and \hyperlink{classOperator_a1a67d9f834722d027cda1525356c436b}{comm221ss()} both require the construction of the intermediate matrices $\mathcal{M}_{pp} $ and $ \mathcal{M}_{hh} $, we can combine them and only calculate the intermediates once. \hypertarget{classOperator_a5f0ebafd8284747ca0dcb35bf2fd4fb0}{\index{Operator@{Operator}!comm222\-\_\-pp\-\_\-hhss@{comm222\-\_\-pp\-\_\-hhss}}
...
\end{DoxyParamCaption}
) const}}\label{classOperator_a70139e405d99a645f57c37ccd2294c75}
\[ \bar{X}^{J}_{i\bar{j}k\bar{l}} = - \sum_{J'} (2J'+1) \left\{ \begin{array}{lll} j_i & j_j & J \\ j_k & j_l & J' \\ \end{array} \right\} X^{J}_{ilkj} \] \hypertarget{classOperator_aaa9163ed47bb4c3330c58fcab09d4cae}{\index{Operator@{Operator}!Get\-Orbits\-From\-Three\-Body\-Index@{Get\-Orbits\-From\-Three\-Body\-Index}}
\index{Get\-Orbits\-From\-Three\-Body\-Index@{Get\-Orbits\-From\-Three\-Body\-Index}!Operator@{Operator}}
\subsubsection[{Get\-Orbits\-From\-Three\-Body\-Index}]{\setlength{\rightskip}{0pt plus 5cm}void Operator\-::\-Get\-Orbits\-From\-Three\-Body\-Index (
\begin{DoxyParamCaption}
\item[{orbindx3\-\_\-t}]{orb\-\_\-indx, }
\item[{int \&}]{a, }
\item[{int \&}]{b, }
\item[{int \&}]{c, }
\item[{int \&}]{d, }
...
\item[{int \&}]{f}
\end{DoxyParamCaption}
)}}\label{classOperator_aaa9163ed47bb4c3330c58fcab09d4cae}
If we have an index, undo the hashing function and extract the corresponding orbit indices. \hypertarget{classOperator_aa08e81b63a14ef552ab8bd645196cfdb}{\index{Operator@{Operator}!Get\-T\-B\-M\-Emonopole@{Get\-T\-B\-M\-Emonopole}}
...
Get three body matrix element in proton-\/neutron formalism. \[ V_{abcdef}^{(pn)} = \sum_{t_{ab} t_{de} T} <t_a t_b | t_{ab}> <t_d t_e | t_{de}> <t_{ab} t_c | T> <t_{de} t_f| T> V_{abcdef}^{t_{ab} t_{de} T} \] \hypertarget{classOperator_a78c235a23140618f76e5d17e2afc4582}{\index{Operator@{Operator}!Get\-Three\-Body\-Orbit\-Index@{Get\-Three\-Body\-Orbit\-Index}}
\index{Get\-Three\-Body\-Orbit\-Index@{Get\-Three\-Body\-Orbit\-Index}!Operator@{Operator}}
\subsubsection[{Get\-Three\-Body\-Orbit\-Index}]{\setlength{\rightskip}{0pt plus 5cm}orbindx3\-\_\-t Operator\-::\-Get\-Three\-Body\-Orbit\-Index (
\begin{DoxyParamCaption}
\item[{int}]{a, }
\item[{int}]{b, }
\item[{int}]{c, }
...
\item[{int}]{f}
\end{DoxyParamCaption}
)}}\label{classOperator_a78c235a23140618f76e5d17e2afc4582}
Hashing function for compressing 6 orbit indices to one long long int. This number is then used as a key for the top level map of the Three\-Body storage structure. \hypertarget{classOperator_acb9d7959232a636191b91f6bf5b7b0c8}{\index{Operator@{Operator}!Norm@{Norm}}
...
Set a three body matrix element. Since only a subset of orbit orderings are stored, we need to recouple if the input ordering is different. \hypertarget{classOperator_a894e29959b3f7b2008c4442683bf8642}{\index{Operator@{Operator}!Three\-Body\-Recoupling\-Coefficient@{Three\-Body\-Recoupling\-Coefficient}}
\index{Three\-Body\-Recoupling\-Coefficient@{Three\-Body\-Recoupling\-Coefficient}!Operator@{Operator}}
\subsubsection[{Three\-Body\-Recoupling\-Coefficient}]{\setlength{\rightskip}{0pt plus 5cm}double Operator\-::\-Three\-Body\-Recoupling\-Coefficient (
\begin{DoxyParamCaption}
\item[{int}]{a\-\_\-in, }
\item[{int}]{b\-\_\-in, }
\item[{int}]{c\-\_\-in, }
...
\item[{int}]{Jab, }
\item[{int}]{J, }
\item[{char}]{j\-\_\-or\-\_\-t}
\end{DoxyParamCaption}
)}}\label{classOperator_a894e29959b3f7b2008c4442683bf8642}
Calculate the angular momentum or isospin recoupling coefficients needed to rearrange (abc) to the proper ordering. 
...
The one body piece of the operator, stored in a single Nx\-N armadillo matrix, where N is the number of single-\/particle orbits. \hypertarget{classOperator_a2f3d3ccaa254194b81442fe01c39160d}{\index{Operator@{Operator}!Three\-Body@{Three\-Body}}
