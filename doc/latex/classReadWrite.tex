...
\item 
void {\bfseries Set3\+N\+Format} (string fmt)\hypertarget{classReadWrite_ac1580fbee6fe0c6db72570080f32a326}{}\label{classReadWrite_ac1580fbee6fe0c6db72570080f32a326}
...
\subsubsection[{\texorpdfstring{Count\+\_\+\+Darmstadt\+\_\+3body\+\_\+to\+\_\+read(\+Operator \&\+Hbare, int E1max, int E2max, int E3max, vector$<$ int $>$ \&orbits\+\_\+remap, vector$<$ size\+\_\+t $>$ \&nread\+\_\+list)}{Count_Darmstadt_3body_to_read(Operator &Hbare, int E1max, int E2max, int E3max, vector< int > &orbits_remap, vector< size_t > &nread_list)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t Read\+Write\+::\+Count\+\_\+\+Darmstadt\+\_\+3body\+\_\+to\+\_\+read (
\begin{DoxyParamCaption}
\item[{{\bf Operator} \&}]{Hbare, }
\item[{int}]{E1max, }
\item[{int}]{E2max, }
\item[{int}]{E3max, }
\item[{vector$<$ int $>$ \&}]{orbits\+\_\+remap, }
\item[{vector$<$ size\+\_\+t $>$ \&}]{nread\+\_\+list}
\end{DoxyParamCaption}
)}\hypertarget{classReadWrite_a61a1a2eeb9b94d6dbf754ca668639d5c}{}\label{classReadWrite_a61a1a2eeb9b94d6dbf754ca668639d5c}
Read me3j format three-\/body matrix elements. Pass in E1max, E2max, E3max for the file, so that it can be properly interpreted. The modelspace truncation doesn\textquotesingle{}t need to coincide with the file truncation. For example, you could have an emax=10 modelspace and read from an emax=14 file, and the matrix elements with emax$>$10 would be ignored. \index{Read\+Write@{Read\+Write}!Get\+H\+D\+F5\+Basis@{Get\+H\+D\+F5\+Basis}}
...
Read two body matrix elements from file formatted for Petr Navratil\textquotesingle{}s no-\/core shell model code. These are given as normalized, JT coupled matix elements. Matrix elements corresponding to orbits outside the modelspace are ignored. \index{Read\+Write@{Read\+Write}!Store\+\_\+\+Darmstadt\+\_\+3body@{Store\+\_\+\+Darmstadt\+\_\+3body}}
\index{Store\+\_\+\+Darmstadt\+\_\+3body@{Store\+\_\+\+Darmstadt\+\_\+3body}!Read\+Write@{Read\+Write}}
\subsubsection[{\texorpdfstring{Store\+\_\+\+Darmstadt\+\_\+3body(const vector$<$ float $>$ \&\+Three\+B\+M\+E, const vector$<$ size\+\_\+t $>$ \&nread\+\_\+list, const vector$<$ int $>$ \&orbits\+\_\+remap, Operator \&\+Hbare, int E1max, int E2max, int E3max)}{Store_Darmstadt_3body(const vector< float > &ThreeBME, const vector< size_t > &nread_list, const vector< int > &orbits_remap, Operator &Hbare, int E1max, int E2max, int E3max)}}]{\setlength{\rightskip}{0pt plus 5cm}void Read\+Write\+::\+Store\+\_\+\+Darmstadt\+\_\+3body (
\begin{DoxyParamCaption}
\item[{const vector$<$ float $>$ \&}]{Three\+B\+ME, }
\item[{const vector$<$ size\+\_\+t $>$ \&}]{nread\+\_\+list, }
\item[{const vector$<$ int $>$ \&}]{orbits\+\_\+remap, }
\item[{{\bf Operator} \&}]{Hbare, }
\item[{int}]{E1max, }
\item[{int}]{E2max, }
\item[{int}]{E3max}
\end{DoxyParamCaption}
)}\hypertarget{classReadWrite_a0796220c5ad1b8b07674d91174f2e237}{}\label{classReadWrite_a0796220c5ad1b8b07674d91174f2e237}
Read me3j format three-\/body matrix elements. Pass in E1max, E2max, E3max for the file, so that it can be properly interpreted. The modelspace truncation doesn\textquotesingle{}t need to coincide with the file truncation. For example, you could have an emax=10 modelspace and read from an emax=14 file, and the matrix elements with emax$>$10 would be ignored. \index{Read\+Write@{Read\+Write}!Write\+Nu\+Shell\+X\+\_\+intfile@{Write\+Nu\+Shell\+X\+\_\+intfile}}
...
Write the valence space part of the interaction to a Nu\+ShellX $\ast$.int file. Note that for operators other than the Hamiltonian Nu\+ShellX assumes identical orbits for protons and neutrons, so that the pnpn interaction should be equal to the pnnp interaction. This is only approximately true for interactions generated with I\+M\+S\+RG, so some averaging is required. \index{Read\+Write@{Read\+Write}!Write\+One\+Body\+\_\+\+Oslo@{Write\+One\+Body\+\_\+\+Oslo}}
\index{Write\+One\+Body\+\_\+\+Oslo@{Write\+One\+Body\+\_\+\+Oslo}!Read\+Write@{Read\+Write}}
\subsubsection[{\texorpdfstring{Write\+One\+Body\+\_\+\+Oslo(string filename, Operator \&\+Hbare)}{WriteOneBody_Oslo(string filename, Operator &Hbare)}}]{\setlength{\rightskip}{0pt plus 5cm}void Read\+Write\+::\+Write\+One\+Body\+\_\+\+Oslo (
\begin{DoxyParamCaption}
\item[{string}]{filename, }
\item[{{\bf Operator} \&}]{Hbare}
\end{DoxyParamCaption}
)}\hypertarget{classReadWrite_a13494cd64fa5cd54c235494f2f6ad98a}{}\label{classReadWrite_a13494cd64fa5cd54c235494f2f6ad98a}
