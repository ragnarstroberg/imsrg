...
PYBIND11_MODULE(pyIMSRG, m)
{
  m.doc() = "python bindings for IMSRG code";
   ...
   py::class_<TwoBodyChannel>(m,"TwoBodyChannel")
      ...
      .def("GetKet",(Ket& (TwoBodyChannel::*) (int)) &TwoBodyChannel::GetKet)
   ...
   py::class_<ModelSpace>(m,"ModelSpace")
      ...
      .def("GetOneBodyChannel",(std::vector<index_t>& (ModelSpace::*) (int,int,int)) &ModelSpace::GetOneBodyChannel)
      .def("GetOneBodyChannel",(std::vector<index_t>& (ModelSpace::*) (index_t)) &ModelSpace::GetOneBodyChannel)
   ...
   py::class_<TwoBodyME>(m,"TwoBodyME")
      ...
      .def("GetMatrix",(arma::mat&  (TwoBodyME::*)(size_t,size_t)) &TwoBodyME::GetMatrix )
      .def("GetMatrix",(arma::mat&  (TwoBodyME::*)(size_t)) &TwoBodyME::GetMatrix )
   ;
...
//      .def("GetH_s",&IMSRGSolver::GetH_s,return_value_policy<reference_existing_object>())
   ...
   py::class_<Jacobi3BME>(m,"Jacobi3BME")
      ...
      .def("SetLmaxNO2b",&Jacobi3BME::SetLmaxNO2b)
//      .def("SetJmaxFile",&Jacobi3BME::SetJmaxFile)
      .def("SetJmaxCut",&Jacobi3BME::SetJmaxCut)
      ...
      .def_readwrite("matelNO2b",&Jacobi3BME::matelNO2b)
   ;
