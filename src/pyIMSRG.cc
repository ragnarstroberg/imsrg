...
//          .def("SetE3max", &Operator::SetE3max)
      ...
      py::class_<HartreeFock>(m, "HartreeFock")
          ...
          .def("SetReferenceParity", &HartreeFock::SetReferenceParity)
          .def("ClearReferenceParity", &HartreeFock::ClearReferenceParity)
          .def("GetReferenceParityConstraint", &HartreeFock::GetReferenceParityConstraint)
