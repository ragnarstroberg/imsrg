...
//      .def(py::init<>())
      ...
      .def("Test_comm110ss", &UnitTest::Test_comm111ss)
      .def("Test_comm220ss", &UnitTest::Test_comm111ss)
      .def("Test_comm111ss", &UnitTest::Test_comm111ss)
      .def("Test_comm121ss", &UnitTest::Test_comm111ss)
      .def("Test_comm221ss", &UnitTest::Test_comm111ss)
      .def("Test_comm122ss", &UnitTest::Test_comm111ss)
      .def("Test_comm222_pp_hhss", &UnitTest::Test_comm111ss)
      .def("Test_comm222_phss", &UnitTest::Test_comm111ss)
      .def("Test_comm222_pp_hh_221ss", &UnitTest::Test_comm111ss)
      ///
