...
ReadWrite::ReadWrite()
: doCoM_corr(false), goodstate(true),LECs({-0.81,-3.20,5.40,1.271,-0.131}),File2N("none"),File3N("none") // default to the EM2.0_2.0 LECs
{
}
...
void ReadWrite::WriteNuShellX_intfile(Operator& op, string filename, string mode)
{
   ...
   intfile << "! input 2N: " << File2N << endl;
   intfile << "! input 23: " << File3N << endl;
