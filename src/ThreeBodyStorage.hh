...
//  virtual ThreeBodyStorage& operator-=(const ThreeBodyStorage&) =0;
  ...
  virtual ME_type GetME_pn(  int Jab_in, int Jde_in, int twoJ, int a, int b, int c, int d, int e, int f) const =0;
  virtual ME_type GetME_iso( int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoTabc, int twoTdef, int a, int b, int c, int d, int e, int f) const =0;
//  virtual ME_type GetME_iso( int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoT, int a, int b, int c, int d, int e, int f) const =0;
  ...
  virtual void SetME_iso(int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoTabc, int twoTdef, int a, int b, int c, int d, int e, int f, ME_type V) =0;
//  virtual void SetME_iso(int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoT, int a, int b, int c, int d, int e, int f, ME_type V) =0;
  virtual void SetME_pn( int Jab_in, int Jde_in, int twoJ, int a, int b, int c, int d, int e, int f, ME_type V) =0;

  virtual void AddToME_iso(int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoTabc, int twoTdef, int a, int b, int c, int d, int e, int f, ME_type V) =0;
//  virtual void AddToME_iso(int Jab_in, int Jde_in, int twoJ, int tab_in, int tde_in, int twoT, int a, int b, int c, int d, int e, int f, ME_type V) =0;
  virtual void AddToME_pn( int Jab_in, int Jde_in, int twoJ, int a, int b, int c, int d, int e, int f, ME_type V) =0;

  // In some cases, for efficiency we may want to set by channel and ket index number, rather than abcdef.
  virtual void AddToME_pn_ch(size_t ch_bra, size_t ch_ket, size_t ibra, size_t iket, ME_type V) =0;
  virtual void SetME_pn_ch(  size_t ch_bra, size_t ch_ket, size_t ibra, size_t iket, ME_type V) =0;

  virtual ME_type GetME_pn_ch(size_t chbra, size_t chket, size_t ibra, size_t iket) const =0;
//  virtual ME_type GetME_pn_ch(size_t chbra, size_t chket, Ket3& bra, Ket3& ket) const =0; // do we use this??
  ...
  std::vector<ME_type> GetME_pn_TwoOps(int Jab, int Jde, int twoJ, int a, int b, int c, int d, int e, int f, const ThreeBodyStorage& X, const ThreeBodyStorage& Y) const ;
  ...
  Permutation SortOrbits(int a_in, int b_in, int c_in, int& a, int& b, int& c) const;
