...
#pragma omp parallel for
  ...
  void comm223_322_BruteForce(const Operator &Eta, const Operator &Gamma, Operator &Z)
  {
    ...
    //   diagram Ia
    //
    //   I(a)^J0_pgqh = 1/2 * 1/ (2 jp + 1) \sum_abcd J2 \delta_{jd, jp}
...
#pragma omp parallel for
    for (int ch = 0; ch < nch; ++ch)
    {
      ...
      for (int ibra = 0; ibra < nKets; ++ibra)
      {
        ...
        for (int iket = 0; iket < nKets; ++iket)
        {
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  for (int J2 = j2min; J2 <= j2max; J2++)
                  {
                    zpgqh += occfactor * (2 * J2 + 1) * Eta.TwoBody.GetTBME_J(J2, b, p, a, c) * Eta.TwoBody.GetTBME_J(J2, a, c, b, d) * Gamma.TwoBody.GetTBME_J(J0, d, g, q, h);
                  }
                }
              }
            }
          ...
          Z.TwoBody.GetMatrix(ch, ch)(ibra, iket) += 0.5 * zpgqh / (op.j2 + 1.0);
          if (ibra != iket)
            Z.TwoBody.GetMatrix(ch, ch)(iket, ibra) += 0.5 * zpgqh / (op.j2 + 1.0);

          // Z2.AddToTBME(ch, ch, ibra, iket, 0.5 * zpgqh / (op.j2 + 1.0));
    ...
    if (EraseTB)
      ...
      //   diagram Ib
      //
      //   I(b)^J0_pgqh = 1/2 * 1/ (2 jq + 1) \sum_abcd J2  \delta_{jd, jq}
...
#pragma omp parallel for
    for (int ch = 0; ch < nch; ++ch)
    {
      ...
      for (int ibra = 0; ibra < nKets; ++ibra)
      {
        ...
        for (int iket = 0; iket < nKets; ++iket)
        {
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  int j2min = std::max(std::abs(oa.j2 - od.j2), std::abs(ob.j2 - oc.j2)) / 2;
                  int j2max = std::min(oa.j2 + od.j2, ob.j2 + oc.j2) / 2;
                  double occfactor = (nbar_a * n_b * n_c + nbar_b * nbar_c * n_a);

                  for (int J2 = j2min; J2 <= j2max; J2++)
                  {
                    zpgqh += occfactor * (2 * J2 + 1) * Eta.TwoBody.GetTBME_J(J2, a, d, b, c) * Eta.TwoBody.GetTBME_J(J2, b, c, a, q) * Gamma.TwoBody.GetTBME_J(J0, p, g, d, h);
                  }
                }
              }
            }
          ...
          Z.TwoBody.GetMatrix(ch, ch)(ibra, iket) += 0.5 * zpgqh / (oq.j2 + 1.0);
          if (ibra != iket)
            Z.TwoBody.GetMatrix(ch, ch)(iket, ibra) += 0.5 * zpgqh / (oq.j2 + 1.0);

          // Z2.AddToTBME(ch, ch, ibra, iket, 0.5 * zpgqh / (oq.j2 + 1.0));
    ...
    if (EraseTB)
      ...
      //   diagram IIa
      //
      //   II(a)^J0_pgqh = - \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
    for (int ch = 0; ch < nch; ++ch)
    {
      ...
      for (int ibra = 0; ibra < nKets; ++ibra)
      {
        ...
        for (int iket = 0; iket < nKets; ++iket)
        {
          ...
          Z.TwoBody.GetMatrix(ch, ch)(ibra, iket) -= zpgqh;
          if (ibra != iket)
            Z.TwoBody.GetMatrix(ch, ch)(iket, ibra) -= zpgqh;
    ...
    if (EraseTB)
      ...
      //   diagram IIb
      //
      //   II(b)^J0_pghq = - \sum_{abcd J2 J3 J4 J5} ( 2 * J2 + 1 ) ( 2 * J3 + 1 )
      //                   ( 2 * J4 + 1 ) ( 2 * J5 + 1 )
      //
...
#pragma omp parallel for
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  // int j5min = std::max(std::abs(oq.j2 - od.j2), std::abs(op.j2 - oa.j2)) / 2;
                  // int j5max = std::min(oq.j2 + od.j2, op.j2 + oa.j2) / 2;
    ...
    if (EraseTB)
      ...
      //   diagram IIc
      //
      //   II(c)^J0_pgqh = -\sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IId
      //
      //   II(d)^J0_pgqh = \sum_{abcd J2 J3 J4 J5} ( 2 * J2 + 1 ) ( 2 * J3 + 1 )
      //                   ( 2 * J4 + 1 ) ( 2 * J5 + 1 )
      //
      //                   { jq jd J5 } { jp ja J5 } { J0 J5 J4 } { J0 J4 J5 }
      //                   { jc jb J2 } { jc jb J3 } { jd jh jq } { ja jp jg }
...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IIe
      //
      //   II(e)^J0_pgqh = - 1/2 \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
    for (int ch = 0; ch < nch; ++ch)
    {
      ...
      for (int ibra = 0; ibra < nKets; ++ibra)
      {
        ...
        for (int iket = 0; iket < nKets; ++iket)
        {
          ...
          Z.TwoBody.GetMatrix(ch, ch)(ibra, iket) -= 0.5 * zpgqh;
          if (ibra != iket)
            Z.TwoBody.GetMatrix(ch, ch)(iket, ibra) -= 0.5 * zpgqh;
    ...
    if (EraseTB)
      ...
      //   diagram IIf
      //
      //   II(f)^J0_pgqh = - 1/2 \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IIIa
      //
      //   III(a)^J0_pgqh = \sum_{abcd J2 J3 J4 J5} ( 2 * J2 + 1 ) ( 2 * J3 + 1 )
      //                   ( 2 * J4 + 1 ) ( 2 * J5 + 1 )
      //
...
#pragma omp parallel for
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  // int j5min = std::max(std::abs(oa.j2 - ob.j2), std::abs(oq.j2 - od.j2)) / 2;
                  // int j5max = std::min(oa.j2 + ob.j2, oq.j2 + od.j2) / 2;
    ...
    if (EraseTB)
      ...
      //   diagram IIIb
      //
      //   III(b)^J0_pgqh = \sum_{abcd J2 J3 J4 J5} ( 2 * J2 + 1 ) ( 2 * J3 + 1 )
      //                   ( 2 * J4 + 1 ) ( 2 * J5 + 1 )
      //
...
#pragma omp parallel for
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  // int j5min = std::max(std::abs(oa.j2 - ob.j2), std::abs(op.j2 - od.j2)) / 2;
                  // int j5max = std::min(oa.j2 + ob.j2, op.j2 + od.j2) / 2;
    ...
    if (EraseTB)
      ...
      //   diagram IIIc
      //
      //   III(c)^J0_pgqh = - \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  // int j4min = std::max(std::abs(oq.j2 - ob.j2), std::abs(oc.j2 - oa.j2)) / 2;
                  // int j4max = std::min(oq.j2 + ob.j2, oc.j2 + oa.j2) / 2;
    ...
    if (EraseTB)
      ...
      //   diagram IIId
      //
      //   III(d)^J0_pgqh = - \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IIIe
      //
      //   III(e)^J0_pgqh = - 1/2 \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
...
#pragma omp parallel for
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  for (int J2 = j2min; J2 <= j2max; J2++)
                  {
                    for (int J3 = j3min; J3 <= j3max; J3++)
                    {
                      ...
                      for (int J4 = j4min; J4 <= j4max; J4++)
                      {
                        double sixj1 = Z.modelspace->GetCachedSixJ(jh, jq, J0, jg, jp, J4);
                        double sixj2 = Z.modelspace->GetCachedSixJ(J2, J3, J4, jq, jg, jc);
                        double sixj3 = Z.modelspace->GetCachedSixJ(J2, J3, J4, jp, jh, jd);
    ...
    if (EraseTB)
      ...
      //   diagram IIIf
      //
      //   III(f)^J0_pgqh = - 1/2 \sum_{abcd J2 J3 J4} ( 2 * J2 + 1 ) ( 2 * J3 + 1 ) ( 2 * J4 + 1 )
      //
      //                   { jh jq J0 } { J2 J3 J4 } { J2 J3 J4 }
      //                   { jg jp J4 } { jp jh jd } { jq jg Jc }
      //
...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IVa
      //
      //   IV(a)^J0_pgqh = - 1/2 1/ (2jq + 1) \sum_abcd J2 \delta_{jd, jq}
      //                   ( \bar{n_a} n_b n_c + \bar{n_b} \bar{n_c} n_a )
...
#pragma omp parallel for
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  for (int J2 = j2min; J2 <= j2max; J2++)
                  {
                    zpgqh += occfactor * (2 * J2 + 1) * Eta.TwoBody.GetTBME_J(J2, b, c, a, q) * Eta.TwoBody.GetTBME_J(J0, p, g, d, h) * Gamma.TwoBody.GetTBME_J(J2, a, d, b, c);
                  }
                }
              }
            }
    ...
    if (EraseTB)
      ...
      //   diagram IVb
      //
      //   IV(b)^J0_pgqh = - 1/2 1/ (2jp + 1) \sum_abcd J2 \delta_{jd, jp}
      //                   ( \bar{n_a} \bar{n_c} n_b + \bar{n_b} n_a n_c )
            ...
            for (auto &b : Z.modelspace->all_orbits)
            {
              ...
              for (auto &c : Z.modelspace->all_orbits)
              {
                ...
                for (auto &d : Z.modelspace->all_orbits)
                {
                  ...
                  for (int J2 = j2min; J2 <= j2max; J2++)
                  {
                    zpgqh += occfactor * (2 * J2 + 1) * Eta.TwoBody.GetTBME_J(J2, b, p, a, c) * Eta.TwoBody.GetTBME_J(J0, d, g, q, h) * Gamma.TwoBody.GetTBME_J(J2, a, c, b, d);
                  }
                }
              }
            }
