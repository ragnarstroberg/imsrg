...
#ifndef SQRT2
  #define SQRT2 1.4142135623730950488L // This many decimal points seems a bit excessive...
#endif
...
//                  if(ch==2 ) std::cout << " J3 = " << J3 << " abcdef " << bra.p << " " << bra.q << " " << a << " " << ket.p << " " << ket.q << " " << b << "    rho  " << rho(a,b)
//                                      << " * " << J3+1 << " * " <<  Hbare.ThreeBody.GetME_pn(J,J,J3,bra.p,bra.q,a,ket.p,ket.q,b)
//                                      << "( = " << (J3+1)*Hbare.ThreeBody.GetME_pn(J,J,J3,bra.p,bra.q,a,ket.p,ket.q,b)
//                                      << " ,  t=00,T=1: " << Hbare.ThreeBody.GetME(J,J,J3,0,0,1,bra.p,bra.q,a,ket.p,ket.q,b)
//                                      << " ,  t=01,T=1: " << Hbare.ThreeBody.GetME(J,J,J3,0,1,1,bra.p,bra.q,a,ket.p,ket.q,b)
//                                      << " ,  t=11,T=1: " << Hbare.ThreeBody.GetME(J,J,J3,1,1,1,bra.p,bra.q,a,ket.p,ket.q,b)
...
//            V3NO(j,i) = V3NO(i,j);
     ...
     // Now we get the normal ordered part of the 3-body from the jacobi basis
