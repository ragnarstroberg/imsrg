...
namespace imsrg_util
{
 ...
 Operator OperatorFromString(ModelSpace& modelspace, string opname )
 {
      ...
      else if (opnamesplit[0] =="HCM" and opnamesplit.size()>1)
      {
...
//         char pn,lspec;
//         int n,l,j,t;
//         istringstream(opnamesplit[1].substr(0,1)) >> pn;
//         istringstream(opnamesplit[1].substr(1,1)) >> n;
//         istringstream(opnamesplit[1].substr(2,1)) >> lspec;
//         istringstream(opnamesplit[1].substr(3,opnamesplit[1].size())) >> j;
//         l = lvals[lspec];
//         t = pn == 'p' ? -1 : 1;
...
//        std::cout << "TROUBLE... I don't know operator " << dmopname << " that will cause problems..." << std::endl;
      }
