...
#pragma omp parallel for
    ...
    if (EraseTB)
      ...
      //   diagram IIb
      //
      //   II(b)^J0_pghq = - 1/2 * P(p/g) * P(q/h) * \sum_{abcd J2 J3 J4 J5} ( 2 * J2 + 1 ) ( 2 * J3 + 1 )
      //                   ( 2 * J4 + 1 ) ( 2 * J5 + 1 )
      //
...
#pragma omp parallel for
  ...
  std::vector<double> &comm223_231_BruteForce_Test(const Operator &Eta, const Operator &Gamma, Operator &Z)
  {
    int index_i = 1;
