...
../compiled/ValenceSpace 2bme=${vnn} 3bme=${v3n} emax=${emax} e3max=${e3max} valence_space=${valence_space} hw=${hw} flowfile=${flowfile} smax=${smax} ${file3} denominator_delta=${delta} intfile=${intfile} omega_norm_max=${omega_norm_max} domega=${domega} A=${A}
